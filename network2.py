...
         neurônio na camada final que tenha a maior ativação."""
    ...
    def CrossEntropyCost(self, output_activations, y):
        """Retorna o custo da entropia cruzada para as ativações de saída e rótulos de destino fornecidos ou armazenados."""
